(() => {
  ...
  function drawCoin() {
    ...
    const coinY = deckY - 16 + fallProgress * fallProgress * height * 0.24;
    ...
    text(copy('card moves; coin stays horizontally still', '卡片移动；硬币水平方向近似静止'), width * 0.5, height * 0.9, '#9eafc4', 'center');
