...
Media listed here is not covered by this repository's MIT license.
...
### `assets/media/Tycho_supernova_xray.jpg`

- Creator: NASA/CXC/Rutgers/J. Warren and J. Hughes et al.
...
- Collider and orbital footage without a clearly verified redistribution license: linked to authoritative source pages only. Do not download or commit it without per-asset permission.
