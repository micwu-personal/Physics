...
const LOCALES = {
  'en': {
    ...
    'machine.desc': 'Move through an original spacetime diagram from the earliest modeled era into a conditional far future.',
    ...
    'machine.rep.caption': 'Original diagram; no external artwork is reproduced. Time runs left to right. Each ellipse is a 2D spatial slice, and its half-height maps the modeled physical radius on a logarithmic meter scale. Hatched early scales and the dashed future are model-dependent; the shape is not an edge of the whole universe.',
    'machine.diagram.title': 'History of today\'s observable patch',
    'machine.diagram.drag': 'Drag through cosmic time',
    'machine.diagram.slider': 'Choose a time in cosmic history',
    'machine.diagram.radiusAxis': 'physical radius · log₁₀ metres',
    'machine.diagram.history': 'modeled history',
    'machine.diagram.future': 'conditional Λ future',
    'machine.diagram.now': 'now',
    'machine.diagram.unknown': 'absolute scale unknown',
    'machine.diagram.futureScale': 'scale grows beyond the plotted range',
    'machine.diagram.radiusValue': 'modeled radius',
    'machine.diagram.model': 'model-dependent',
    'machine.event.inflation': 'inflation',
    'machine.event.oneSecond': '1 second',
    'machine.event.bbn': 'light nuclei',
    'machine.event.cmb': 'CMB released',
    'machine.event.stars': 'first stars',
    'machine.event.now': 'today',
    'machine.event.future': 'black-hole era',
    ...
    'scale.axis': 'Logarithmic radius scale in metres',
    'scale.view': 'View this slice',
  ...
  'zh-CN': {
    ...
    'machine.h2': '宇宙时间机器',
    'machine.desc': '在原创时空图中穿越宇宙历史，从最早的模型时期一直到条件性的遥远未来。',
    ...
    'machine.rep.caption': '本图为原创，没有复制外部作品。时间从左向右；每个椭圆代表二维空间切片，其半高度按米制物理半径的对数映射。带纹理的早期尺度与虚线未来依赖模型；轮廓并非整个宇宙的边缘。',
    'machine.diagram.title': '今天可观测区域的历史',
    'machine.diagram.drag': '拖动，穿越宇宙时间',
    'machine.diagram.slider': '选择宇宙历史中的一个时刻',
    'machine.diagram.radiusAxis': '物理半径 · 米的 log₁₀',
    'machine.diagram.history': '模型化历史',
    'machine.diagram.future': '条件性 Λ 未来',
    'machine.diagram.now': '现在',
    'machine.diagram.unknown': '绝对尺度未知',
    'machine.diagram.futureScale': '尺度增长超出图示范围',
    'machine.diagram.radiusValue': '模型半径',
    'machine.diagram.model': '依赖模型',
    'machine.event.inflation': '暴胀',
    'machine.event.oneSecond': '1 秒',
    'machine.event.bbn': '轻元素原子核',
    'machine.event.cmb': 'CMB 释放',
    'machine.event.stars': '第一代恒星',
    'machine.event.now': '今天',
    'machine.event.future': '黑洞时代',
